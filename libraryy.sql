...
-- -----------------------------------------------------
-- Schema 3762242_library
-- -----------------------------------------------------

-- -----------------------------------------------------
-- Schema 3762242_library
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `3762242_library` DEFAULT CHARACTER SET utf8 ;
USE `3762242_library` ;

-- -----------------------------------------------------
-- Table `3762242_library`.`TIPO_USUARIO`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `3762242_library`.`TIPO_USUARIO` (
...
-- -----------------------------------------------------
-- Table `3762242_library`.`EIXO`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `3762242_library`.`EIXO` (
...
-- -----------------------------------------------------
-- Table `3762242_library`.`CURSO`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `3762242_library`.`CURSO` (
  ...
  CONSTRAINT `fk_CURSO_EIXO1`
    ...
    REFERENCES `3762242_library`.`EIXO` (`IDEIXO`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `3762242_library`.`USUARIO`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `3762242_library`.`USUARIO` (
  ...
  CONSTRAINT `fk_USUARIO_TIPO_USUARIO`
    ...
    REFERENCES `3762242_library`.`TIPO_USUARIO` (`IDTIPO_USUARIO`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_USUARIO_CURSO1`
    FOREIGN KEY (`CURSO_IDCURSO`)
    REFERENCES `3762242_library`.`CURSO` (`IDCURSO`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `3762242_library`.`TRABALHO`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `3762242_library`.`TRABALHO` (
...
-- -----------------------------------------------------
-- Table `3762242_library`.`AUTOR`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `3762242_library`.`AUTOR` (
  ...
  CONSTRAINT `fk_USUARIO_has_TRABALHO_USUARIO1`
    ...
    REFERENCES `3762242_library`.`USUARIO` (`IDUSUARIO`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_USUARIO_has_TRABALHO_TRABALHO1`
    FOREIGN KEY (`TRABALHO_IDTRABALHO`)
    REFERENCES `3762242_library`.`TRABALHO` (`IDTRABALHO`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `3762242_library`.`HISTORICO`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `3762242_library`.`HISTORICO` (
